...
acceptance_tests(
  ...
  test => {
    $ENV{NO_TODO} ? () : ( todo_tests => [
      ...
      Test::JSON::Schema::Acceptance->VERSION < '1.027' ? { file => 'optional/ecmascript-regex.json', group_description => '\a is not an ECMA 262 control escape', test_description => 'when used as a pattern' } : (),
